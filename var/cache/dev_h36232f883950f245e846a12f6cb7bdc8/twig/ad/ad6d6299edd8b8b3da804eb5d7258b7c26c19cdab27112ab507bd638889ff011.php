...
class __TwigTemplate_b3c73a12a683864e138a4efb660594224d21261fd72e30b780dc92390ca4adf0 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
        // line 56
        if ((twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "customer", [], "any", false, false, false, 56) &&  !twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "customer", [], "any", false, false, false, 56), "guest", [], "any", false, false, false, 56))) {
            // line 57
...
\t{% endblock %}
{% endblock %}
", "@Storefront/storefront/page/product-detail/review/review.html.twig", "/var/www/stage.joes-toolbox.de/vendor/shopware/storefront/Resources/views/storefront/page/product-detail/review/review.html.twig");
    }
}
